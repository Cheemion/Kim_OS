#ifndef __MYOS_GUI_WIDGET_H
#define __MYOS_GUI_WIDGET_H
#include "../common/types.h"
#include "../common/graphicscontext.h"
#include "../drivers/keyboard.h"

using myos::common::GraphicsContext;
...
namespace myos {
	...
	class Widget : public myos::drivers::KeyboardEventHandler {
	    ...
	    virtual void OnMouseDown(common::int32_t x, common::int32_t y, uint8_t button);
	    virtual void OnMouseUp(common::int32_t x, common::int32_t y, uint8_t button);
